...
export default function AgeVerification() {
  ...
  return (
    ...
    >
      ...
      {/* Modal */}
      <div className="relative z-10 w-full max-w-lg mx-4 bg-bg-secondary border border-border rounded-2xl shadow-2xl overflow-hidden">
        {/* Header avec gradient */}
        <div className="bg-gradient-to-r from-accent-primary/20 to-accent-hover/20 px-6 py-8 text-center border-b border-border">
          {/* Logo/Icon */}
          <div className="w-20 h-20 mx-auto mb-4 rounded-full bg-bg-tertiary border-2 border-accent-primary flex items-center justify-center">
            <span className="text-4xl font-bold text-accent-primary">18+</span>
          </div>

          <h1 className="text-2xl md:text-3xl font-bold text-text-primary mb-2">
            Contenu réservé aux adultes
          </h1>
          <p className="text-text-secondary flex items-baseline justify-center gap-0">
            ...
            <span className="ml-2">- Annuaire des clubs libertins</span>
          </p>
        </div>
        ...
        <div className="px-6 py-6">
          ...
          <div className="bg-bg-tertiary border border-border rounded-lg p-4 mb-6">
            <p className="text-sm text-text-secondary text-center">
              ...
              strictement interdit aux mineurs. En cas de doute, quittez immédiatement ce site.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <button
              ...
              className="flex-1 px-6 py-4 bg-accent-primary text-bg-primary font-bold rounded-lg hover:bg-accent-hover transition-all duration-200 hover:shadow-lg hover:shadow-accent-primary/20 text-center"
            >
              J'ai 18 ans ou plus
            </button>
            <button
              onClick={handleLeave}
              className="flex-1 px-6 py-4 bg-transparent border border-border text-text-secondary font-semibold rounded-lg hover:bg-bg-tertiary hover:text-text-primary transition-all duration-200 text-center"
            >
              Quitter le site
            </button>
          </div>
        ...
        {/* Footer */}
        <div className="px-6 py-4 bg-bg-tertiary border-t border-border">
