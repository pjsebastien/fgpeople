...
const TYPE_CATEGORIES_CONFIG: Record<ClubTypeSlug, Omit<TypeCategory, 'clubCount'>> = {
  ...
  spa: {
    ...
    label: 'Spa & Wellness',
    labelPlural: 'Spas et wellness libertins',
  ...
  restaurant: {
    ...
    label: 'Restaurant',
    labelPlural: 'Restaurants libertins',
  ...
  hebergement: {
    ...
    label: 'Hébergement',
    labelPlural: 'Hébergements libertins',
  ...
  sm: {
    ...
    label: 'SM & Fétish',
    labelPlural: 'Clubs SM et fétish',
  ...
  gay: {
    ...
    label: 'Gay friendly',
    labelPlural: 'Clubs gay friendly',
  ...
  discotheque: {
    ...
    label: 'Discothèque',
    labelPlural: 'Discothèques libertines',
